namespace Astrilla_WebEditor_WinForms
{
    partial class ZodiacSigns
    {
        ...
        {
            zodiacSignTitle = new Label();
            btn_SelectionAquarius = new Button();
            btn_SelectionFish = new Button();
            btn_SelectionAries = new Button();
            btn_SelectionTaurus = new Button();
            btn_SelectionGemini = new Button();
            btn_SelectionCancer = new Button();
            btn_SelectionLeo = new Button();
            btn_SelectionVirgo = new Button();
            btn_SelectionLibra = new Button();
            ...
            zodiacSignTitle.Text = "Sternzeichen";
            // 
            ...
            Controls.Add(btn_SelectionAries);
            Controls.Add(btn_SelectionTaurus);
            Controls.Add(btn_SelectionGemini);
            Controls.Add(btn_SelectionCancer);
            Controls.Add(btn_SelectionLeo);
            Controls.Add(btn_SelectionVirgo);
            Controls.Add(btn_SelectionCapricorn);
        ...
        private Label zodiacSignTitle;
        private Button btn_SelectionAquarius;
        private Button btn_SelectionFish;
        private Button btn_SelectionAries;
        private Button btn_SelectionTaurus;
        private Button btn_SelectionGemini;
        private Button btn_SelectionCancer;
        private Button btn_SelectionLeo;
        private Button btn_SelectionVirgo;
        private Button btn_SelectionCapricorn;
